hi clear
syntax reset
let g:colors_name = "summer-pastels"
if &background == "light"
    hi Boolean gui=NONE guifg=#80ff93 guibg=NONE
    hi ColorColumn gui=NONE guifg=NONE guibg=#1a1a1a
    hi Comment gui=NONE guifg=#fcff42 guibg=NONE
    hi Conceal gui=NONE guifg=#808080 guibg=NONE
    hi Conditional gui=NONE guifg=#80ffff guibg=NONE
    hi Constant gui=NONE guifg=#80ff93 guibg=NONE
    ...
    hi Number gui=NONE guifg=#80ff93 guibg=NONE
    ...
    hi Special gui=NONE guifg=#80ff93 guibg=NONE
    ...
    hi Statement gui=NONE guifg=#80ffff guibg=NONE
...
elseif &background == "dark"
    ...
    hi TabLine gui=NONE guifg=#707070 guibg=#262626
    hi TabLineFill gui=NONE guifg=NONE guibg=#262626
    hi TabLineSel gui=NONE guifg=#9e9e9e guibg=#151519
    hi Title gui=NONE guifg=#c2c2c2 guibg=NONE
    hi Todo gui=NONE guifg=#ff0000 guibg=#151519
    hi Type gui=NONE guifg=#c2c2c2 guibg=NONE
    hi Underlined gui=NONE guifg=NONE guibg=NONE
    hi VertSplit gui=NONE guifg=#333333 guibg=NONE
    hi Visual gui=NONE guifg=#fff0c2 guibg=#0000d1
