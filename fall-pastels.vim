hi clear
syntax reset
let g:colors_name = "fall-pastels"
if &background == "light"
    hi Boolean gui=NONE guifg=#6ba234 guibg=NONE
    hi ColorColumn gui=NONE guifg=NONE guibg=#1a1a1a
    hi Comment gui=NONE guifg=#616161 guibg=NONE
    hi Conceal gui=NONE guifg=#808080 guibg=NONE
    hi Conditional gui=NONE guifg=#ffa347 guibg=NONE
    hi Constant gui=NONE guifg=#6ba234 guibg=NONE
    ...
    hi Number gui=NONE guifg=#6ba234 guibg=NONE
    ...
    hi Special gui=NONE guifg=#6ba234 guibg=NONE
    ...
    hi Statement gui=NONE guifg=#ffa347 guibg=NONE
    ...
    hi String gui=NONE guifg=#6ba234 guibg=NONE
