hi clear
syntax reset
let g:colors_name = "spring-pastels"
if &background == "light"
    hi Boolean gui=NONE guifg=#fd81b5 guibg=NONE
    ...
    hi Conditional gui=NONE guifg=#80ff93 guibg=NONE
    hi Constant gui=NONE guifg=#fd81b5 guibg=NONE
    ...
    hi Number gui=NONE guifg=#fd81b5 guibg=NONE
    ...
    hi Special gui=NONE guifg=#fd81b5 guibg=NONE
    ...
    hi Statement gui=NONE guifg=#80ff93 guibg=NONE
    ...
    hi String gui=NONE guifg=#fd81b5 guibg=NONE
